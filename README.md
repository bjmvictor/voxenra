...
[macOS · Apple Silicon](https://github.com/l5769389/voxenra/releases/download/v1.3.0/Voxenra-1.3.0-macos-arm64.dmg) · [Windows · 安装版](https://github.com/l5769389/voxenra/releases/download/v1.3.0/Voxenra-1.3.0-windows-x64-setup.exe) · [Windows · 便携版](https://github.com/l5769389/voxenra/releases/download/v1.3.0/Voxenra-1.3.0-windows-x64-portable.exe) · [版本记录](https://github.com/l5769389/voxenra/releases)
...
| 测量与分割 | 长度、角度、矩形／椭圆／自由形状 ROI；阈值分割、VOI、区域管理与统计。 |
...
- **测量**：长度、角度、矩形／椭圆／自由形状 ROI，提供面积、周长和强度统计；支持编辑、复制粘贴、撤销重做。
