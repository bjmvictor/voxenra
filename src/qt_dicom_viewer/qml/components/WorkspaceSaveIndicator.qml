...
Item {
    ...
    readonly property string statusText: controller?.recoveryStatusText ?? qsTrId("text.0737")
    ...
    AppToolTip {
        ...
        text: indicator.statusText + qsTrId("text.0738") + (indicator.controller?.recoveryPath ?? "")
    }
}
