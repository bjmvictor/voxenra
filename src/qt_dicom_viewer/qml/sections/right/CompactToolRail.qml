...
Flickable {
    ...
    readonly property var groupedTools: ["rotate", "measure", "annotate", "pseudocolor"]
    contentWidth: width
    ...
    function activateChild(tool, action) {
        if (tool === "rotate") viewportController.applyTransformAction(action)
    ...
    Column {
        ...
        Repeater {
            model: (rail.toolController?.tools ?? []).filter(t => t.available !== false &&
                (rail.directTools.includes(t.toolType) || rail.groupedTools.includes(t.toolType)))
            delegate: Column {
                id: group
                ...
                Components.ToolbarAction {
                    ...
                    iconName: group.modelData.iconName
                    iconSize: 22
                    checked: rail.toolController?.activeTool === group.modelData.toolType
                    ...
                    Rectangle {
                        visible: rail.groupedTools.includes(group.modelData.toolType)
                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            delegate: Components.ToolbarAction {
                                ...
                                iconSize: 19
                                tooltipPlacement: "left"
                                actionEnabled: !!rail.viewportController
                                checked: group.modelData.toolType === "pseudocolor"
